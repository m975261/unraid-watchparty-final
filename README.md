...
## Docker Image
```
docker pull muaeabudhabi/watchparty-final:latest
```

## Install on Unraid
1. Download `unraid-templates/my-watchparty-final.xml`
2. Copy to `/boot/config/plugins/dockerMan/templates-user/`
3. Docker tab → Add Container → select `watchparty-final`
